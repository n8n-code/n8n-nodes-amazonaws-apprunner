...
![amazonaws-apprunner Banner](banner.svg)

[![npm version](https://img.shields.io/npm/v/@n8n-dev/n8n-nodes-amazonaws-apprunner.svg)](https://www.npmjs.com/package/@n8n-dev/n8n-nodes-amazonaws-apprunner)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

---

**Stop writing amazonaws-apprunner API integrations by hand.**

Every time you connect n8n to amazonaws-apprunner, you waste hours mapping endpoints, defining parameters, and debugging schemas. You copy-paste from docs, fix edge cases, and pray nothing breaks.

**What if connecting n8n to amazonaws-apprunner took 5 minutes, not half a day?**
...
```bash
npm install @n8n-dev/n8n-nodes-amazonaws-apprunner
```

**Or in n8n:**
1. **Settings → Community Nodes → Install**
2. Search: `@n8n-dev/n8n-nodes-amazonaws-apprunner`
3. Click **Install**
...
2. Add credentials: **amazonaws-apprunner API** → paste your API key
3. Drag the **amazonaws-apprunner** node into your workflow
...
- Copy-pasting from amazonaws-apprunner docs
- Debugging auth, pagination, error handling
- Maintaining your own client code

**With this node:**
- Install → configure → use. 5 minutes.
- Auto-generated from the official amazonaws-apprunner OpenAPI spec
...
## Auto-Generated
This node was auto-generated from the official **amazonaws-apprunner** OpenAPI specification using
[@n8n-dev/n8n-openapi-node-ultimate](https://github.com/kelvinzer0/n8n-openapi-node-ultimate),
then validated against the live API so you get accurate types and real parameters, not guesswork.

When the amazonaws-apprunner API updates, this node updates too.
